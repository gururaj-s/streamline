...
echo "">sender_out.log
echo "numbits ArrSzMultCache bps ber ber10 ber01 ber1bit bermultibit" > bitrate_arraysz_results.txt;
echo "numbits ArrSzMultCache bps ber | ber10 ber01 | ber1bit bermultibit"
